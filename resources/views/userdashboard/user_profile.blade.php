...
@push('ul')
    <ul class="navbar-nav" id="navbar-nav">
        ...
        <li class="nav-item">
            <a href="{{url('userdashboard')}}" class="nav-link menu-link collapsed" role="button" aria-controls="sidebarDashboards">
                <i class="bi bi-diagram-3"></i> <span data-key="t-dashboards">Dashboards</span>
            </a>
        </li>

        <li class="nav-item">
            <a href="{{url('user_contact')}}" class="nav-link menu-link"> <i class="bi bi-person-vcard"></i> <span data-key="t-email">Contacat Details</span> </a>
        </li>

        <li class="nav-item">
            <a href="{{url('user_profile')}}" class="nav-link menu-link active"> <i class="bi bi-person-circle"></i> <span data-key="t-email">Profile</span> </a>
        </li>
                ...
                <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                  ...
                  <form>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="email" type="email" class="form-control" id="Email" value="user@gmail.com">
                      </div>
                    </div>
