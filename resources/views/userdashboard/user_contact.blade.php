...
@push('ul')
    <ul class="navbar-nav" id="navbar-nav">
        ...
        <li class="nav-item">
            <a href="{{url('user_contact')}}" class="nav-link menu-link active"> <i class="bi bi-person-vcard"></i> <span data-key="t-email">Contacat Details</span> </a>
        </li>

        <li class="nav-item">
            <a href="{{url('user_profile')}}" class="nav-link menu-link"> <i class="bi bi-person-circle"></i> <span data-key="t-email">Profile</span> </a>
        </li>
